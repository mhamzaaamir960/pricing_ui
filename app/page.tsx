  ...
  return (
   <>
      ...
      {/* <div className='bg-slate-300 flex justify-center items-center h-screen'>
        <div className='flex flex-wrap bg-white rounded-xl sm:w-[994px] sm:h-[336px] w-[382px] h-[606px] mx-10 '>
          <div className='sm:basis-1/3 bg-violet-100 sm:h-full md:h-[336px] sm:rounded-l-xl flex 
          justify-center items-center w-[382px] h-[283px] basis-100 rounded-t-xl'>
           <div className='text-center '>
            <h1 className='text-xl font-bold my-2'>Premium PRO</h1>
                <span className='block text-5xl font-semibold '>$329</span>
                <p className=' font-light text-lg'>billed just once</p>
                <button className='border bg-violet-500 text-white sm:px-8 md:px-16 
                py-1 my-4 rounded-xl px-16'>
                  Get Started
            </button>
          </div>
